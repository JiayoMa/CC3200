...
void LCD_Show_StandbyPage(void) //显示"待机页面"-"彩屏LCD_ILI9325"
{
	...
	LCD_ILI9341_TFT_fillrect(0, 40,319,79,Red);
	LCD_ILI9341_TFT_fillrect(0, 80,319,119,Red);
	...
	LCD_TFT_ShowString( 130,8,"2050971",FONT1608,White,Red);
	LCD_TFT_ShowString(120,48,"majiayua",FONT1608,GreenYellow,Red);

	yStart = 98;
	for(ChNum = 0;ChNum < 5; ChNum++) //2050971
	{
		LCD_Show_ChFont2424(80,yStart,ChNum,White,Red);
		yStart += 26;
	}


	yStart = 118;
	for(ChNum = 5;ChNum < 9; ChNum++)//MSP430_FFTB
	{
		LCD_Show_ChFont2424(128,yStart,ChNum,Black,Green);  //LIGHTGREEN
		yStart += 24;
	}



	LCD_TFT_ShowString(90,168,"AndyMa5@outlook.com",FONT1608,Red,GreenYellow);

	LCD_TFT_ShowString(105,208,"www.tongji.com",FONT1608,Blue,Yellow);
